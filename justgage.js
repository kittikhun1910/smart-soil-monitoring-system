...
JustGage = function(config) {
  ...
  obj.config = {
    ...
    // width : int
    // gauge width
    width: kvLookup('width', config, dataset, 220),

    // height : int
    // gauge height
    height: kvLookup('height', config, dataset, 220),
    ...
    titleFontColor: kvLookup('titleFontColor', config, dataset, "#505050"),

    // titleFontFamily : string
    // color of gauge title
    titleFontFamily: kvLookup('titleFontFamily', config, dataset, "Vollkorn"),
    ...
    valueFontColor: kvLookup('valueFontColor', config, dataset, "#505050"),

    // valueFontFamily : string
    // color of label showing current value
    valueFontFamily: kvLookup('valueFontFamily', config, dataset, "Vollkorn"),
    ...
    // shadowSize: int
    // inner shadow size
    shadowSize: kvLookup('shadowSize', config, dataset, 10),
    ...
    levelColors: kvLookup('levelColors', config, dataset, ["#EE1630", "#EEE716", "#16EE1E", "#EEE716", "#EE1630", ], 'array', ','),
    ...
    valueMinFontSize: kvLookup('valueMinFontSize', config, dataset, 15),

    // titleMinFontSize
    // absolute minimum font size for the title
    titleMinFontSize: kvLookup('titleMinFontSize', config, dataset, 15),
